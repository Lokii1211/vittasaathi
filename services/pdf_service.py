...
class PDFReportService:
    ...
    def generate_monthly_report(self, user_id: str, month: str = None) -> Optional[str]:
        ...
        # Create filename
        filename = f"VittaSaathi_Report_{user_id}_{month_name}.pdf"
        ...
        # ===== HEADER =====
        story.append(Paragraph("💰 VittaSaathi", title_style))
        ...
        story.append(Paragraph("Generated by VittaSaathi - Your Financial Friend", footer_style))
    ...
    def generate_yearly_summary(self, user_id: str, year: int = None) -> Optional[str]:
        ...
        # Create filename
        filename = f"VittaSaathi_Annual_{user_id}_{year}.pdf"
        filepath = self.reports_dir / filename
        ...
        story.append(Paragraph("💰 VittaSaathi Annual Report", title_style))
        ...
        story.append(Paragraph("Generated by VittaSaathi", styles['Normal']))
